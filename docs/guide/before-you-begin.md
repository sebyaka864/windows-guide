...
Copy personal files, browser exports, game saves, license keys, and two-factor recovery codes to storage that is not the PC you are working on. If BitLocker is enabled, save its recovery key somewhere you can access without that computer.
