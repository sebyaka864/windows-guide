module.exports = {
  guideSidebar: [
    ...
    { type: 'doc', id: 'guide/telemetry', label: 'easy telemetry disable' },
    ...
    { type: 'doc', id: 'guide/optimization', label: 'optimization' },
    { type: 'doc', id: 'guide/other-guides', label: 'other guides' },
  ],
};
